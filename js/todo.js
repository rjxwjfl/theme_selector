class TodoEvent {
    ...
    addEventConfigToDoClick() {
        const configButtons = document.querySelectorAll(".content-footer .modify-button");
        configButtons.forEach((configButton, index) => {
            configButton.onclick = () => {
                ModalService.getInstance().showConfigModal(index);
            }
        });
    }
...
class TodoService {
    ...
    loadTodoList() {
        ...
        TodoEvent.getInstance().addEventConfigToDoClick();
